...
namespace TP.ConcurrentProgramming.BusinessLogic.Test
{
    ...
    public class BusinessLogicImplementationUnitTest
    {
        ...
        private class DimensionsStub : Data.IDimensions
        {
            public double Radius { get; init; }
            public int Height { get; init; }
            public int Width { get; init; }

            public DimensionsStub(double radius, int height, int width)
            {
                Radius = radius;
                Height = height;
                Width = width;
        ...
        private class DataLayerConstructorFixture : Data.DataAbstractAPI
        {
            ...
            private DimensionsStub _dimensions = new DimensionsStub(20, 400, 420);
        ...
        private class DataLayerStartFixture : Data.DataAbstractAPI
        {
            ...
            public override void Start(int numberOfBalls, Action<Vector2, Data.IBall> upperLayerHandler)
            {
                ...
                for (int i = 0; i < numberOfBalls; i++)
                {
                    ...
                    DataBallFixture newBall = new DataBallFixture(dummyPos, new Vector2(1, 1), _dimensions.Radius);
                    _balls.Add(newBall);
            ...
            public override void SpawnBall(Action<Vector2, Data.IBall> upperLayerHandler)
            {
                Vector2 dummyPos = new Vector2(100, 100);
                DataBallFixture newBall = new DataBallFixture(dummyPos, new Vector2(1, 1), _dimensions.Radius);
                _balls.Add(newBall);
                upperLayerHandler?.Invoke(dummyPos, newBall);
            }
        ...
        public void GetDimensionsReturnsCorrectBusinessDimensions()
        {
            ...
            TP.ConcurrentProgramming.BusinessLogic.IBusinessDimensions dimensions = businessLogic.GetDimensions();

            Assert.IsNotNull(dimensions);
            Assert.AreEqual(400, dimensions.Height);
            Assert.AreEqual(420, dimensions.Width);
            Assert.AreEqual(20, dimensions.Diameter);
        }
